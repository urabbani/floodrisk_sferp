...
export const layerTree: LayerGroup = {
  ...
  children: [
    ...
    // HDTM (DEM workspace)
    {
      ...
      visible: false,
      children: [
        createRasterLayer('HDTM Tile 1 (e68n26)', '1_e68n26_HDTM1mV2', false, 0.6, GEOSERVER_CONFIG.workspaces.dem),
        createRasterLayer('HDTM Tile 2 (e67n26)', '2_e67n26_HDTM1mV3', false, 0.6, GEOSERVER_CONFIG.workspaces.dem),
        createRasterLayer('HDTM Tile 3 (e68n27)', '3_e68n27_HDTM1mV2', false, 0.6, GEOSERVER_CONFIG.workspaces.dem),
        createRasterLayer('HDTM Tile 4 (e67n27)', '4_e67n27_HDTM1mV2', false, 0.6, GEOSERVER_CONFIG.workspaces.dem),
        createRasterLayer('HDTM Tile 5 (e69n28)', '5_e69n28_HDTM1m', false, 0.6, GEOSERVER_CONFIG.workspaces.dem),
        createRasterLayer('HDTM Tile 6 (e68n28)', '6_e68n28_HDTM1m', false, 0.6, GEOSERVER_CONFIG.workspaces.dem),
        createRasterLayer('HDTM Tile 7 (e67n28)', '7_e67n28_HDTM1m', false, 0.6, GEOSERVER_CONFIG.workspaces.dem),
        createRasterLayer('HDTM Tile 8 (e68n29)', '8_e68n29_HDTM1m', false, 0.6, GEOSERVER_CONFIG.workspaces.dem),
        createRasterLayer('HDTM Tile 9 (e67n29)', '9_e67n29_HDTM1m', false, 0.6, GEOSERVER_CONFIG.workspaces.dem),
      ],
    },
  ],
};
